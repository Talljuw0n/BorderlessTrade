...
export default function ArticleT2T() {
  return (
    <ArticleLayout
      breadcrumb="Africa"
    ...
    >
      ...
      <p>
        The programme is part of the broader ECOWAS Regional Project 2026, focused on strengthening enterprise
      ...
      <p>
        Participants will go through a three-phase journey covering market preparation and compliance, market access
        and buyer engagement, and ultimately transaction execution and FX settlement.
      </p>
      <p>
        Through this process, SMEs will gain access to practical trade systems, financing pathways specific to
        export and trade, logistics advisory, and verified routes into markets across Africa, the United States,
        the Caribbean, Canada, and the United Kingdom.
      </p>
      <p>
        Applications are now open and will close on <strong>April 13, 2026</strong>. Due to the competitive nature

...
export default function Home() {
  return (
    ...
    >
      ...
      <div style={sx('position:relative; height:660px; overflow:hidden; background:#0F0326;')}>
        <div
          style={sx(
        ...
        ></div>
        <Header overlay />
        <div style={sx('position:absolute; left:0; right:0; bottom:0; z-index:10; padding:0 56px 64px;')}>
      ...
      <Section background="#48483A">
        <div style={sx('color:#F6F3EC; display:grid; grid-template-columns:repeat(5,1fr);')}>
          {stats.map((s, i) => (
            <div
              key={s.label}
              style={sx(`padding:40px 26px;${i < stats.length - 1 ? ' border-right:1px solid rgba(246,243,236,.14);' : ''}`)}
            >
              <div style={sx("font-family:'Newsreader',serif; font-size:44px; font-weight:500;")}>
      ...
      <div style={sx('padding:88px 56px; display:grid; grid-template-columns:.42fr .58fr; gap:64px;')}>
        ...
        <div style={sx('color:#4C4658; font-size:18px;')}>
          ...
          <div style={sx('display:grid; grid-template-columns:1fr 1fr; gap:0; border-top:1px solid #D8D1C4;')}>
            <div style={sx('padding:26px 26px 26px 0; border-right:1px solid #D8D1C4;')}>
            ...
            <div style={sx('padding:26px 0 26px 26px;')}>
      ...
      {/* THREE PILLARS */}
      <div style={sx('padding:0 56px 88px;')}>
      ...
      <div style={sx('padding:80px 56px;')}>
        <div style={sx('display:flex; justify-content:space-between; align-items:flex-end; margin-bottom:34px;')}>
          <div>
        ...
        <table style={sx('width:100%; border-collapse:collapse; font-size:15px;')}>
          ...
          <tbody style={sx('color:#3A3448;')}>
            {transactions.map((t, i) => (
              ...
              >
                <td style={sx('padding:17px 16px 17px 0; font-weight:600; color:#0F0326;')}>{t.sector}</td>
                <td style={sx('padding:17px 16px;')}>{t.year}</td>
                <td style={sx("padding:17px 16px; text-align:right; font-family:'IBM Plex Mono',monospace;")}>
                  {t.value}
                </td>
                <td style={sx('padding:17px 16px;')}>{t.role}</td>
                <td style={sx('padding:17px 0 17px 16px; color:#6B6478;')}>{t.instrument}</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <div style={sx('padding:84px 56px;')}>
        ...
        <div style={sx('display:grid; grid-template-columns:1fr 1fr;')}>
          ...
          <div style={sx('padding:24px 0 24px 40px;')}></div>
        </div>
      </div>

      {/* WOMEN IN BUSINESS SPOTLIGHT */}
      <Section background="#476C9B">
        <div style={sx('color:#F6F3EC; display:grid; grid-template-columns:.9fr 1.1fr; align-items:stretch;')}>
          <div style={sx('position:relative; min-height:420px; background:#0F0326;')}>
            <img
          ...
          <div style={sx('padding:70px 56px;')}>

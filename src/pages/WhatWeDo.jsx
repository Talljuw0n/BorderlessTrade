  ...
  return (
    <div style={sx('width:100%; background:#EFEAE1; font-size:16px; line-height:1.6; overflow-x:hidden;')}>
      ...
      <div style={sx('position:relative; height:560px; overflow:hidden; background:#0F0326;')}>
        ...
        ></div>
        <Header overlay />
        <div style={sx('position:absolute; inset:0; display:flex; flex-direction:column; justify-content:flex-end; padding:0 56px 58px;')}>
          <div style={sx('max-width:820px; border-left:3px solid #476C9B; padding-left:28px;')}>
            ...
            <h1 style={sx('font-weight:800; font-size:48px; line-height:1.06; letter-spacing:-.02em; color:#F6F3EC;')}>
      ...
      <div style={sx('padding:70px 56px 40px;')}>
        <p style={sx('font-size:22px; line-height:1.5; color:#3A3448; max-width:900px; font-weight:500;')}>
      ...
      <div style={sx('padding:20px 56px 80px; display:flex; flex-direction:column; gap:24px;')}>
        {pillars.map((p) => (
          <div
            key={p.tag}
          ...
          >
            ...
            <div style={sx('display:grid; grid-template-columns:1fr 1fr; gap:18px 32px; align-content:start;')}>
              {p.items.map((item) => (
      ...
      <div style={sx('padding:80px 56px;')}>
        ...
        <div style={sx('display:grid; grid-template-columns:repeat(3,1fr); gap:16px;')}>
          {sectors.map((s) => (
      ...
      <Section background="#476C9B">
        <div style={sx('padding:70px 56px; color:#F6F3EC; display:flex; align-items:center; justify-content:space-between; gap:40px; flex-wrap:wrap;')}>
          <h2 style={sx('font-weight:800; font-size:32px; letter-spacing:-.01em; max-width:640px;')}>
          ...
          <div style={sx('display:flex; gap:14px;')}>
            ...
            <Link to="/contact" style={sx('background:#C1B098; color:#0F0326; padding:15px 28px; font-weight:700; font-size:14px; letter-spacing:.03em;')}>
              PARTNER WITH US
            </Link>
          </div>
        </div>
